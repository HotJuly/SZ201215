...
- 解构对象: *const {id:id, name:name} = this.product*
...
- 分别暴露两种引入方式:import * as A from'@/api'

- export const getProductList =function(){}

- 默认暴露

- export default const getProductList =function(){}

- export const getProductList1 =function(){}

- export const getProductList2 =function(){}

- 完整写法:import {getProductList1 ,getProductList2 ,default as A} from '@/api'

- 简写:import A from '@/api'
