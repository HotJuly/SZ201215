	...
	<view class="cartContainer">
		...
		<!-- 登陆之后的购物车 -->
			...
			<view class="cartFooter">
				...
				@click="allSelected(!isSelectedAll)"
				></text>
...
<script>
	...
	export default {
		...
		methods:{
			...mapMutations(["changeShopItemCount",'changeShopItemSelect','changeAllSelected']),
			changeCount(type,index){
				// console.log('changeCount',type,index)
				this.changeShopItemCount({type,index})
			},
			changeSelect(selected,index){
				this.changeShopItemSelect({selected,index})
			},
